...
// You still do NOT have a real Form Builder UUID for initial assessment.
// Replace this later after saving the initial form in Form Builder.
const DIABETES_INITIAL_FORM_UUID = '';
        ...
        if (!patientUuid) {
            return (
                <Tile className={styles.section}>
                    ...
                    <p>Select or pass a real patient UUID before rendering a clinical form.</p>
                </Tile>
            );
        }

        if (activeForm === 'initial') {
            if (!DIABETES_INITIAL_FORM_UUID) {
                return (
                    <Tile className={styles.section}>
                        <h3>Initial Assessment form not ready</h3>
                        <p>
                            This form has not been saved in Form Builder yet, so it does not have a real UUID.
                        </p>
                        <p>
                            Save the Initial Assessment form in Form Builder, copy its real UUID, and replace
                            <code> DIABETES_INITIAL_FORM_UUID </code>.
                        </p>
                    </Tile>
                );
            }
            ...
            <div className={styles.header}>
                <div>
                    ...
                    <p className={styles.subtitle}>
                        Manage diabetes assessment, follow-up visits, treatment review, and longitudinal care
                        forms.
                    </p>
                </div>
